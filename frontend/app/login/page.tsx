      ...
      <div className="flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <h1 className="font-display text-3xl font-semibold text-white">Neuralix RAG</h1>
            <p className="text-base-600 mt-2 text-sm">Sign in to ask your documents anything.</p>
          </div>
